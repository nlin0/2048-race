...
def main() -> None:
    ...
    p.add_argument(
        ...
        action="store_true",
        help="Match older Game2048Env reward (pre fixed-anchor shaping)",
    )
    p.add_argument("--edge-fill-bonus", type=float, default=0.05)
    p.add_argument("--max-log2-increase-bonus", type=float, default=0.12)
    p.add_argument("--danger-axis-penalty", type=float, default=0.04)
    args = p.parse_args()
